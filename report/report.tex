...
\begin{figure}[H]
    ...
    \subfloat[Haar to 10]{
        \label{ref_label1}
        \includegraphics[width=0.5\textwidth]{hibiscus_fft_0.005.png}
        }
    \subfloat[Original]{
        \label{ref_label2}
        \includegraphics[width=0.5\textwidth]{hibiscus_fft_0.05.png}
        }\\
    \subfloat[Original]{
        \label{ref_label2}
        \includegraphics[width=0.5\textwidth]{hibiscus_orig.png}
        }
