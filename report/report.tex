...
\begin{figure}[H]
    ...
    \subfloat[Haar to 10]{
        \label{ref_label1}
        \includegraphics[width=0.3\textwidth]{balloon_HaarTo_10.png}
        }
    \subfloat[Original]{
        \label{ref_label2}
        \includegraphics[width=0.3\textwidth]{balloon_orig.png}
        }
...
sample images of different size of upper left corner Walsh coefficients here.
\end{flushleft}
\begin{figure}[H]
    \centering
    \subfloat[Walsh to 2]{
